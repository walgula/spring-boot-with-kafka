...
class End2EndTest {
    ...
    @Autowired
    private InputMessagesConsumer inputMessagesConsumeronsumer;
    ...
    private Map<String, Object> getConsumerProperties() {
        return Map.of(
                ...
                ConsumerConfig.GROUP_ID_CONFIG, "e2e",
    ...
    @Test
    void testShouldReturnValidOutputMessageForGivenInputMessage() throws InterruptedException, IOException {
        InputMessage inputMessage = new InputMessage();
        inputMessage.setCity("BERLIN");
        inputMessagesConsumeronsumer.consume(inputMessage);
